...
"""
# ------------------------------------------------------------------------------
# DO: 1. PUT YOUR NAME IN THE ABOVE LINE.  Then delete this
# ------------------------------------------------------------------------------

# ------------------------------------------------------------------------------
# DO: 2. With your instructor, discuss the "big picture" of laptop-robot
# TODO:    communication:
...
# ------------------------------------------------------------------------------
# DO: 3. One team member: change the following in mqtt_remote_method_calls.py:
#                LEGO_NUMBER = 32
# DO:    to use YOUR robot's number instead of 99.
# DO:    Commit and push the change, then other team members Update Project.
# DO:    Then delete this DO.
# ------------------------------------------------------------------------------

# ------------------------------------------------------------------------------
# DO: 4. Run this module.
# DO:    Study its code until you understand how the GUI is set up.
# DO:    Then delete this DO.
# ------------------------------------------------------------------------------
...
def handle_go_forward(entry_box, mqtt_client):
    ...
    # --------------------------------------------------------------------------
    # DO: 6. This function needs the entry box in which the user enters
    # DO:    the speed at which the robot should move.  Make the 2 changes
    # DO:    necessary for the entry_box constructed in  setup_gui
    # --------------------------------------------------------------------------
